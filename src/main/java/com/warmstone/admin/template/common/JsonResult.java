package com.warmstone.admin.template.common;
...
public class JsonResult<T>{
    ...
    private JsonResult(Integer code, String message, T data, Long total) {
        this.code = code;
     ...
     * @return 成功结果
     */
    public static <T> JsonResult<T> ok(T data, Long total) {
     ...
     * @return 成功结果
     */
    public static <T> JsonResult<T> ok(Integer code, String message, T data, Long total) {
        return new JsonResult<>(code, message, data, total);
    }
     ...
     * @return 错误返回
     */
    public static <T> JsonResult<T> fail(Integer code, String message, T data, Long total) {
        return new JsonResult<>(code, message, data, total);
    }
